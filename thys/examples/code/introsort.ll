...
define i64 @Sorting_Log2_size_t_context_log2_iter_impl(i64 %x) {
  ...
  start:
    %x1 = call i64 @Sorting_Export_Code_log2_iter_impl_f_012689416 (i64 %x)
    ret i64 %x1
}
...
define i64* @introsort(i64* %x, i64 %x1, i64 %x2) {
  ...
  then:
    ...
    %xda = call i64* @Sorting_Export_Code_unat_sort_introsort_impl_f_012686362 ({ i64*, { i64, { i64, i64 } } } %tmpc)
    %xea = sub i64 %x2, %x1
...
define i64 @Sorting_Export_Code_log2_iter_impl_f_012689416(i64 %x) {
  ...
  then:
    ...
    %xa = udiv i64 %x, 2
    %xb = call i64 @Sorting_Export_Code_log2_iter_impl_f_012689416 (i64 %xa)
    %x2 = add i64 %xb, 1
    br label %ctd_if
...
define { i8*, { i64, i64 } }* @str_introsort({ i8*, { i64, i64 } }* %x, i64 %x1, i64 %x2) {
  ...
  then:
    ...
    %xda = call { i8*, { i64, i64 } }* @Sorting_Export_Code_string_sort_introsort_impl_f_012707038 ({ { i8*, { i64, i64 } }*, { i64, { i64, i64 } } } %tmpc)
    %xea = sub i64 %x2, %x1
    %xfa = icmp sle i64 %xea, 16
    br i1 %xfa, label %thena, label %elsea
...
define i64* @Sorting_Export_Code_unat_sort_introsort_impl_f_012686362({ i64*, { i64, { i64, i64 } } } %x) {
  ...
  ctd_ifb:
    ...
    %yda = call i64* @Sorting_Export_Code_unat_sort_introsort_impl_f_012686362 ({ i64*, { i64, { i64, i64 } } } %yg)
    ...
    %x7 = call i64* @Sorting_Export_Code_unat_sort_introsort_impl_f_012686362 ({ i64*, { i64, { i64, i64 } } } %x6)
    br label %ctd_ifa
...
define { i8*, { i64, i64 } }* @Sorting_Export_Code_string_sort_introsort_impl_f_012707038({ { i8*, { i64, i64 } }*, { i64, { i64, i64 } } } %x) {
  ...
  ctd_ifb:
    ...
    %yda = call { i8*, { i64, i64 } }* @Sorting_Export_Code_string_sort_introsort_impl_f_012707038 ({ { i8*, { i64, i64 } }*, { i64, { i64, i64 } } } %yg)
    %yh = insertvalue { i64, i64 } zeroinitializer, i64 %a1b, 0
    %tmpj = insertvalue { i64, i64 } %yh, i64 %yca, 1
    %yi4 = insertvalue { i64, { i64, i64 } } zeroinitializer, i64 %a2c2, 0
    %tmpk = insertvalue { i64, { i64, i64 } } %yi4, { i64, i64 } %tmpj, 1
    ...
    %x7 = call { i8*, { i64, i64 } }* @Sorting_Export_Code_string_sort_introsort_impl_f_012707038 ({ { i8*, { i64, i64 } }*, { i64, { i64, i64 } } } %x6)
    br label %ctd_ifa

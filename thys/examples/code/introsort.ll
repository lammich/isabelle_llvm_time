...
define i64 @Sorting_Log2_size_t_context_log2_iter_impl(i64 %x) {
  ...
  start:
    %x1 = call i64 @Sorting_Export_Code_log2_iter_impl_f_018019342 (i64 %x)
    ret i64 %x1
}
...
define i64* @introsort(i64* %x, i64 %x1, i64 %x2) {
  ...
  then:
    ...
    %xda = call i64* @Sorting_Export_Code_unat_sort_introsort_impl_f_018016288 ({ i64*, { i64, { i64, i64 } } } %tmpc)
    %xea = sub i64 %x2, %x1
...
define i64 @Sorting_Export_Code_log2_iter_impl_f_018019342(i64 %x) {
  ...
  then:
    ...
    %xa = udiv i64 %x, 2
    %xb = call i64 @Sorting_Export_Code_log2_iter_impl_f_018019342 (i64 %xa)
    %x2 = add i64 %xb, 1
    br label %ctd_if
...
define i64* @Sorting_Export_Code_unat_sort_introsort_impl_f_018016288({ i64*, { i64, { i64, i64 } } } %x) {
  ...
  ctd_ifb:
    ...
    %yda = call i64* @Sorting_Export_Code_unat_sort_introsort_impl_f_018016288 ({ i64*, { i64, { i64, i64 } } } %yg)
    ...
    %x7 = call i64* @Sorting_Export_Code_unat_sort_introsort_impl_f_018016288 ({ i64*, { i64, { i64, i64 } } } %x6)
    br label %ctd_ifa
